    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              ...
              <div className="absolute -bottom-4 left-4 md:-bottom-8 md:-left-8 glass bg-white/90 p-5 rounded-[2rem] shadow-[0_20px_40px_rgba(230,81,0,0.15)] z-20 flex items-center space-x-5 border border-white animate-float w-max">
      ...
      <section className="py-24 bg-transparent relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <h3 className="text-5xl font-black text-gray-900 mb-16 tracking-tighter leading-none animate-fade-in-up">Our Core <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-amber-500">Values.</span></h3>
