...
const Hero = () => {
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      {/* Centered Content */}
      <div className="max-w-5xl mx-auto px-6 relative z-20 w-full h-full text-center flex flex-col items-center justify-center pt-24">
        ...
        >
          <div className="inline-flex items-center space-x-3 mb-8 glass bg-white/10 rounded-full px-5 py-2 border border-white/20">
            <div className="w-2 h-2 rounded-full bg-brand-primary animate-ping" />
            <span className="text-white font-extrabold uppercase tracking-[0.2em] text-[10px]">Exceptional Engineering</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tighter drop-shadow-sm mb-6 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-2xl text-gray-300 mt-2 mb-10 max-w-2xl mx-auto font-medium tracking-wide">
