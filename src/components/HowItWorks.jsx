...
import { fadeUp, staggerContainer, scaleBounce, lineGrow, viewportOnce } from '../lib/animations';
    ...
    <section className="py-24 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="flex flex-col md:flex-row flex-wrap justify-center items-center md:items-start gap-12 md:gap-8 relative">
          ...
          <motion.div
            className="hidden md:block absolute top-[45px] left-[10%] right-[10%] h-[3px] bg-gradient-to-r from-transparent via-brand-primary/40 to-transparent -z-10 drop-shadow-sm origin-left"
            variants={lineGrow}
            initial="hidden"
            whileInView="visible"
            viewport={viewportOnce}
          ...
          {steps.map((step, index) => (
            <motion.div
              key={index}
              className="flex flex-col items-center text-center max-w-[200px] mx-auto group"
              variants={stepItem}
              custom={index}
              initial="hidden"
              whileInView="visible"
            ...
            >
              <motion.div
                className="w-24 h-24 rounded-[2rem] glass bg-white/80 border-t border-l border-white flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.05)] mb-8 group-hover:-translate-y-3 transition-all duration-500 group-hover:shadow-[0_20px_50px_rgba(230,81,0,0.15)] relative overflow-hidden"
